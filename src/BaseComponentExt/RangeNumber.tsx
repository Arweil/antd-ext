...
interface RangeNumberState {
  minimum?: string;
  maximum?: string;
}

export default class RangeNumber extends PureComponent<RangeNumberProps, RangeNumberState> {
  constructor(props: Readonly<RangeNumberProps>) {
    super(props);
  ...
  static getDerivedStateFromProps(nextProps: Readonly<RangeNumberProps>): RangeNumberState | null {
